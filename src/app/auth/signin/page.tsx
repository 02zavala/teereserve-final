      ...
      <Card className="w-full max-w-md relative z-10 shadow-2xl border-0 bg-white/95 backdrop-blur-sm">
        <CardHeader className="text-center pb-6">
          ...
          <CardTitle className="text-2xl font-bold text-golf-green-600">
            Bienvenido a TeeReserve
          </CardTitle>
          <CardDescription className="text-golf-green-700">
            Inicia sesión para reservar tu tee time perfecto
          </CardDescription>
        </CardHeader>
        ...
        <CardContent className="space-y-6">
          ...
          <div className="relative">
            ...
            <div className="relative flex justify-center text-xs uppercase">
              <span className="bg-white px-2 text-golf-green-600 font-medium">o continúa con email</span>
            </div>
          </div>
          ...
          <div className="text-center">
            <p className="text-sm text-golf-green-600">
              ¿No tienes cuenta?{" "}
              <Link href="/auth/signup" className="font-medium text-golf-gold-600 hover:text-golf-gold-700">
                Regístrate aquí
              </Link>
            </p>
          </div>
