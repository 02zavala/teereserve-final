    ...
    return `
      <div style="max-width: 250px; font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, sans-serif;">
        ...
        <div style="display: flex; gap: 8px; margin-top: 8px;">
          <a href="/courses/${course.id}" style="background: #1E5631; color: white; padding: 6px 12px; border-radius: 6px; text-decoration: none; font-size: 12px; font-weight: bold;">Ver Detalles</a>
