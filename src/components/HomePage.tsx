...
export function HomePage() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-golf-beige-50 to-golf-beige-100 dark:from-gray-900 dark:to-gray-800 transition-colors duration-300">
      {/* Header */}
      <Header />

      {/* Hero Section */}
      <section className="py-24 px-4 relative overflow-hidden">
        {/* Degradado dinámico con efecto tornasolado dorado mejorado */}
        <div className="absolute inset-0 bg-gradient-to-br from-[#1a5d42] via-[#2d7a5a] via-[#4a9b6e] to-[#D4AF37] animate-gradient-shift dark:from-[#0f2419] dark:via-[#1a4d32] dark:to-[#B8941F]"></div>
        ...
        <div className="relative z-10 container mx-auto text-center">
          ...
          <div className="absolute top-20 left-10 w-32 h-32 opacity-20">
            <div className="relative">
              <div className="absolute inset-0 bg-white/15 rounded-full blur-3xl -z-10"></div>
              <div className="absolute inset-0 bg-[#D4AF37]/10 rounded-full blur-2xl -z-10"></div>
            </div>
          </div>
          ...
          {/* Título Principal */}
          <h1 className="title-hero text-white mb-8 drop-shadow-xl">
            {t('home.title')}
          </h1>

          {/* Subtítulo */}
          <p className="text-lg md:text-xl text-white/95 mb-6 max-w-4xl mx-auto leading-relaxed font-medium drop-shadow-md font-montserrat">
            {t('home.subtitle')}
          </p>
          <p className="text-base md:text-lg text-white/90 mb-12 max-w-3xl mx-auto leading-relaxed font-medium drop-shadow-md font-montserrat">
            {t('home.description')}
          </p>

          <div className="flex flex-col sm:flex-row gap-6 justify-center">
            <Link href="/courses">
              <Button size="lg" className="bg-golf-gold-600 hover:bg-golf-gold-700 dark:bg-golf-gold-500 dark:hover:bg-golf-gold-600 text-white px-12 py-4 text-lg font-bold shadow-2xl border-2 border-golf-gold-500/30 transition-all duration-300 hover:scale-105 btn-premium">
